...
namespace QuanLyDangKyDoanhNghiep
{
    public partial class frm_quanly_danhmuc : Form
    {
        ...
        public frm_quanly_danhmuc(frm_giaodien_quantri parentForm, internal_account internal_Account)
        {
            InitializeComponent();
        ...
        private void btn_taikhoan_noibo_Click(object sender, EventArgs e)
        {
            reset_button_style();
        ...
        private void btn_danhmuc_nhanvien_Click(object sender, EventArgs e)
        {
            reset_button_style();
        ...
        private void btn_danhmuc_quoctich_Click(object sender, EventArgs e)
        {
            reset_button_style();
        ...
        private void btn_danhmuc_dantoc_Click(object sender, EventArgs e)
        {
            reset_button_style();
        ...
        private void btn_danhmuc_nganhnghe_Click(object sender, EventArgs e)
        {
            reset_button_style();
        ...
        private void btn_danhmuc_loaihinh_Click(object sender, EventArgs e)
        {
            reset_button_style();
